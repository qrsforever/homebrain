...
crosstool_dir=$pro_top_dir/out/${platform}/staging_dir/toolchain-mipsel_24kc_gcc-5.4.0_musl-1.1.16/
...
__Check_and_Copy $crosstool_dir/lib/libstdc++.so.6.0.21 $dst_lib_dir
__Check_and_Link $dst_lib_dir/libstdc++.so.6.0.21 $dst_lib_dir/ibstdc++.so.6
__Check_and_Link $dst_lib_dir/libstdc++.so.6.0.21 $dst_lib_dir/ibstdc++.so
