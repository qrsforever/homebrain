...
private:
    ...
    /* Commands */
    static std::string _GetBuildInfo(const char *params);
    ...
    static std::string _MakeInstance(const char* params);
    static std::string _DeleteInstance(const char* params);
    ...
    static std::string _SetVirtualMode(const char *params);
