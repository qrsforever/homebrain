/***************************************************************************
 *  SQLiteTable.cpp - Define Table Base Impl
 *
...
SQLiteTable::SQLiteTable(SQLiteDatabase &db, const char *tabName)
    : mDB(db)
    , mTabName(tabName)
{
}
...
bool SQLiteTable::_Update(int currentVersion, int latestVersion)
{
