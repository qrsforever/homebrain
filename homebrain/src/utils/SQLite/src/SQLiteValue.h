/***************************************************************************
 *  SQLiteValue.h - SQLiteValue Header
 *
 *  Created: 2018-06-21 09:47:07
 *
 *  Copyright QRS
 ****************************************************************************/

#ifndef __SQLiteValue_H__
#define __SQLiteValue_H__
...
private:
	...
	friend inline SQLiteValue SQLText(const std::string&);
...
inline SQLiteValue SQLText(const std::string &v)
{
    SQLiteValue tmp(SQLValueType_Text);
    tmp._u.text = v.c_str();
    return tmp;
