...
/*{{{ general --> */
    ...
    bool get_halt_execution();
    void set_halt_execution(bool val);
    bool get_halt_rules();
    void set_halt_rules(bool val);
    bool get_evaluation_error();
    void set_evaluation_error(bool val);
/* <-- general }}}*/
...
/*{{{ get_callback --> */
    ...
    { (void)call; return (UserFunc_t) (void* (*) (void*)) callback_string; }

    template <typename T_arg1>
    int (*get_callback(std::shared_ptr<Functor<std::string, T_arg1>> call))(void*)
    { (void)call; return (UserFunc_t) (void* (*) (void*)) callback_string<T_arg1>; }

    template <typename T_arg1, typename T_arg2>
    int (*get_callback(std::shared_ptr<Functor<std::string, T_arg1, T_arg2>> call))(void*)
    { (void)call; return (UserFunc_t) (void* (*) (void*)) callback_string<T_arg1, T_arg2>; }

    template <typename T_arg1, typename T_arg2, typename T_arg3>
    int (*get_callback(std::shared_ptr<Functor<std::string, T_arg1, T_arg2, T_arg3>> call))(void*)
    { (void)call; return (UserFunc_t) (void* (*) (void*)) callback_string<T_arg1, T_arg2, T_arg3>; }

    template <typename T_arg1, typename T_arg2, typename T_arg3, typename T_arg4>
    int (*get_callback(std::shared_ptr<Functor<std::string, T_arg1, T_arg2, T_arg3, T_arg4>> call))(void*)
    { (void)call; return (UserFunc_t) (void* (*) (void*)) callback_string<T_arg1, T_arg2, T_arg3, T_arg4>; }

    int (*get_callback(std::shared_ptr<Functor<Values>> call))(void*)
    { (void)call; return (UserFunc_t) (void (*) (void*, void*)) callback_multifield; }

    template <typename T_arg1>
    int (*get_callback(std::shared_ptr<Functor<Values, T_arg1>> call))(void*)
    { (void)call; return (UserFunc_t) (void (*) (void*, void*)) callback_multifield<T_arg1>; }

    template <typename T_arg1, typename T_arg2>
    int (*get_callback(std::shared_ptr<Functor<Values>> call))(void*)
    { (void)call; return (UserFunc_t) (void (*) (void*, void*)) callback_multifield<T_arg1, T_arg2>; }

    template <typename T_arg1, typename T_arg2, typename T_arg3>
    int (*get_callback(std::shared_ptr<Functor<Values>> call))(void*)
    { (void)call; return (UserFunc_t) (void (*) (void*, void*)) callback_multifield<T_arg1, T_arg2, T_arg3>; }

    template <typename T_arg1, typename T_arg2, typename T_arg3, typename T_arg4>
    int (*get_callback(std::shared_ptr<Functor<Values>> call))(void*)
    { (void)call; return (UserFunc_t) (void (*) (void*, void*)) callback_multifield<T_arg1, T_arg2, T_arg3, T_arg4>; }

    template <typename T_return>
    int (*get_callback(std::shared_ptr<Functor<T_return>> call))(void*)
    { (void)call; return (UserFunc_t) (T_return (*) (void*)) callback; }

    template <typename T_return, typename T_arg1>
    int (*get_callback(std::shared_ptr<Functor<T_return, T_arg1>> call))(void*)
    { (void)call; return (UserFunc_t) (T_return (*) (void*)) callback<T_return, T_arg1>; }

    template <typename T_return, typename T_arg1, typename T_arg2>
    int (*get_callback(std::shared_ptr<Functor<T_return, T_arg1, T_arg2>> call))(void*)
    { (void)call; return (UserFunc_t) (T_return (*) (void*)) callback<T_return, T_arg1, T_arg2>; }

    template <typename T_return, typename T_arg1, typename T_arg2, typename T_arg3>
    int (*get_callback(std::shared_ptr<Functor<T_return, T_arg1, T_arg2, T_arg3>> call))(void*)
    { (void)call; return (UserFunc_t) (T_return (*) (void*)) callback<T_return, T_arg1, T_arg2, T_arg3>; }

    template <typename T_return, typename T_arg1, typename T_arg2, typename T_arg3, typename T_arg4>
    int (*get_callback(std::shared_ptr<Functor<T_return, T_arg1, T_arg2, T_arg3, T_arg4>> call))(void*)
    { (void)call; return (UserFunc_t) (T_return (*) (void*)) callback<T_return, T_arg1, T_arg2, T_arg3, T_arg4>; }
/* <-- get_callback }}}*/
...
/* <-- get_function_restriction }}}*/
    ...
    std::string mCLPSVersion;
    std::string mCLPSCreator;
    std::string mCLPSDateTime;
