...
#endif
    , mCLPSVersion(""), mCLPSCreator(""), mCLPSDateTime("")
    , mCallback(0)
{
    LOGD("Environment construct.\n");
#ifdef VERSION_STRING
    mCLPSVersion = VERSION_STRING;
#endif
#ifdef CREATION_DATE_STRING
    mCLPSDateTime = CREATION_DATE_STRING;
#endif
#ifdef CREATOR_STRING
    mCLPSCreator = CREATOR_STRING ;
#endif
