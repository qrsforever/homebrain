...
public:
    ...
    virtual int nextValue(::UTILS::SysTime::DateTime &dt, time_t &duration, bool adjust) = 0;
...
public:
    ...
    ~TimeYear(){}
    int nextValue(::UTILS::SysTime::DateTime &dt, time_t &duration, bool adjust);
}; /* class TimeYear */
...
public:
    ...
    int nextDate(::UTILS::SysTime::DateTime &dt, time_t &duration);
